...
export function HeroSection() {
  ...
  return (
    <motion.div
      ...
      className="bg-[#f1f1f1] rounded-lg w-full"
    >
      <section
        id="hero"
        className="flex flex-col-reverse justify-center items-center md:flex-row p-6 lg:p-10 gap-6 "
      >
        {/* Left Content */}
        <div className="space-y-4 text-center md:text-left md:w-6/12 2xl:w-7/12">
          <h1 className="text-xl md:text-2xl lg:text-3xl xl:text-4xl text-[#34344e] font-bold">
            Brig. Gen. Prof. Dr. Md. Saidur Rahman
          </h1>
          <div className="flex items-center justify-center md:justify-start gap-2">
            {/* <img width={32} src="/images/stethoscope2.png" alt="icon" /> */}
            <span className="font-mono text-base md:text-lg xl:text-xl bangla-text font-medium">
              সাবেক চিফ সার্জন ও উপদেষ্টা বিশেষজ্ঞ সার্জন <br /> সি.এম.এইচ, ঢাকা
            </span>
          </div>
          <h2 className="text-[#1F509A] text-base md:text-lg xl:text-xl font-semibold">
            37+ years of experience
          </h2>
          <p className="text-gray-700 text-sm lg:text-base">
            <span className="">MBBS and FCPS (Surgery)</span>
            <br />
          ...
          <div className="flex justify-center md:justify-start gap-3 pt-4 text-sm">
            <button
              onClick={() => scrollToSection("intro")}
              className="bg-[#566981] text-white lg:text-lg p-2 md:p-3 rounded-sm hover:bg-[#3D3BF3]/90 transition"
            >
              Know More
            </button>
            <button
