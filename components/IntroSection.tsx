      ...
      <div className="bg-[#f1f1f1] rounded-lg shadow-lg p-6 md:p-8">
        <div className="flex flex-col xl:flex-row items-center gap-6 md:gap-12">
          ...
          <div className="flex-1 space-y-4 text-center md:text-left md:text-lg">
            <div className="flex-1 space-y-3 bangla-text">
              ...
              <p className="text-gray-600">
                ...
                <span className="block my-2 hover:translate-y-[-3px] transition-all duration-300">
                  ...
                  সুস্থতার পথকে সহজ করে দিতে পারে। সার্জারির ক্ষেত্রে আমি
                  সর্বশেষ প্রযুক্তি ও উন্নত পদ্ধতি ব্যবহার করি।
                </span>
                <br />
                <span className="block hover:translate-y-[-3px] transition-all duration-300">
            ...
            <div className="flex justify-center md:justify-start gap-4 pt-4">
              ...
              <Button
                variant="outline"
                className="flex items-center gap-2 bg-[#566981] text-white"
              >
          ...
          {/* Extra Information */}
          <div className="flex flex-col w-full md:w-auto items-center bg-[#cbdad5] rounded-lg">
            {/* Featured By Section */}
            <div className="border p-4 text-center w-full">
            ...
            <div className="border p-4 w-full text-sm lg:text-base text-[#34344e]">
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  <BeakerIcon className="w-6 h-6 flex-shrink-0" />
